...
const Invite = () => {
    ...
    return (
        <button className="invite-button" onClick={() => setIsDialogShown(true)} >
            <span className="invite-span"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 23 21" height="21" width="23" className="svg-icon">
            ...
            <span className="invite-label">Chanllenge a Friend</span>
        </button>
    )
}
